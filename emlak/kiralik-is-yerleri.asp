...
<title>Kiralık İş Yerleri | <%=emrahbozkurt("sitebasligi")%></title>
			...
			<div align="center">
				<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#C0C0C0" id="table11" bgcolor="#000000" height="23">
					<tr>
						<td>
						<p align="center">
						<font face="Verdana" size="2" color="#FFFFFF">K. İş Yeri</font></td>
					</tr>
				</table>
			</div>
		</td>
...
<table cellpadding="0" cellspacing="0" width="801" height="95%">
   <tr><%metallicamrhbozkurt=1:Set kiralikisyerimrh=Conn.Execute("SELECT * FROM ilanlar where kiralikisyeri=1 ORDER BY id Asc"):Do while Not kiralikisyerimrh.Eof:Set cit=Conn.Execute("SELECT * FROM iller WHERE id=" & kiralikisyerimrh("il")):Set city=Conn.Execute("SELECT * FROM ilceler WHERE id=" & kiralikisyerimrh("ilce")):Set dtm=Conn.Execute("SELECT * FROM ilceler WHERE id=" & kiralikisyerimrh("ilce")):Set dtf=Conn.Execute("SELECT * FROM iller WHERE id=" & kiralikisyerimrh("il"))%>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table11" height="93">
								<tr>
									<td width="121">
									<p align="center">
									<a href="ilan.asp?s-emlak=ilandetayi&id=<%=kiralikisyerimrh("id")%>">
									<img alt="<%=kiralikisyerimrh("ilanbaslik")%>" border="0" src="yonetim/<%If Not kiralikisyerimrh("resim1")="" Then%><%=kiralikisyerimrh("resim1")%><%Else%>ilanfoto/smultimedya_foto_yok.jpg<%End If%>" width="116" height="87" style="border: 1px solid #FFFFFF; "></a></td>
									<td>
									<div align="center">
										...
										<font size="2" face="Tahoma">&nbsp;İ.No</font></td>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikisyerimrh("id")%></font></td>
											</tr>
											<tr>
												<td width="40">
											...
											<tr>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikisyerimrh("ilan_tip")%></font></td>
											</tr>
											<tr>
												<td width="40">
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikisyerimrh("tip")%></font></td>
											</tr>
										</table>
									</div>
									</td>
