...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="97%" bordercolor="#F4F4F4" id="table2">
	<tr>
		...
		<td width="624"><font size="2" face="Tahoma" color="#808080">&nbsp;<A HREF="javascript:popUp('iletisim-gelen-ayrinti.asp?iletisim=<%=ali("id")%>')"><%=ali("adsoyad")%></A></font></td>
		<td>
		<p align="left"><font size="2" face="Tahoma" color="#CC3300">
		<a href="mrh-modul.asp?process=iletisim-sil&id=<%=ali("id")%>" style="text-decoration: none">Sil</a></font></td>
	</tr>
</table>
