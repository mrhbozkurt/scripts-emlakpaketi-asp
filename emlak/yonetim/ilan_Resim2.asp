...
response.write(" <br><input ONCLICK=""window.opener.document.ilan.resim2.value='"&FileName&"';alert('Ýþlem tamam teþekkür ederiz.');JavaScript:onClick=window.close()"" type=button value=""Ýþlemi Bitirmek Ýçin Týklayýnýz"" " & _
FileName & "<BR>")
End Sub 
%>
