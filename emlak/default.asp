...
<table id="table2" width="841" height="801" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			<img alt="Emlak Vitrini" src="images/smultimedya-emlak-v.01_18.gif" width="83" height="33" alt=""></td>
		<td colspan="2">
			...
			<div align="center">
				<table border="0" cellpadding="0" style="border-collapse: collapse" width="804" bordercolor="#C0C0C0" id="table6" background="images/smultimedya-emlak-v.01_20.gif" height="175">
					<tr>
						<td bgcolor="#5A5A4E">
						<div align="center">
							<table border="0" cellpadding="0" width="100%" id="table11" height="176" style="border-collapse: collapse">
								<tr>
									<td height="61"><!--#include file="vitrin-ilanlari.asp"--></td>
								</tr>
								</table>
						</div>
						</td>
