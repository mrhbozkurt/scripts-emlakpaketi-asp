...
<title>Satılık Emlaklar | <%=emrahbozkurt("sitebasligi")%></title>
			...
			<div align="center">
				<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#C0C0C0" id="table11" bgcolor="#000000" height="23">
					<tr>
						<td>
						<p align="center">
						<font color="#FFFFFF" size="2" face="Verdana">Satılıklar</font></td>
					</tr>
				</table>
			</div>
		</td>
...
<table cellpadding="0" cellspacing="0" width="801" height="95%">
   <tr><%metallica=1:Set satiliklarmrh=Conn.Execute("SELECT * FROM ilanlar where satiliklar=1 ORDER BY id Asc"):Do while Not satiliklarmrh.Eof:Set cit=Conn.Execute("SELECT * FROM iller WHERE id=" & satiliklarmrh("il")):Set city=Conn.Execute("SELECT * FROM ilceler WHERE id=" & satiliklarmrh("ilce")):Set dtm=Conn.Execute("SELECT * FROM ilceler WHERE id=" & satiliklarmrh("ilce")):Set dtf=Conn.Execute("SELECT * FROM iller WHERE id=" & satiliklarmrh("il"))%>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table11" height="93">
								<tr>
									<td width="121">
									<p align="center">
									<a href="ilan.asp?s-emlak=ilandetayi&id=<%=satiliklarmrh("id")%>">
									<img alt="<%=satiliklarmrh("ilanbaslik")%>" border="0" src="yonetim/<%If Not satiliklarmrh("resim1")="" Then%><%=satiliklarmrh("resim1")%><%Else%>ilanfoto/smultimedya_foto_yok.jpg<%End If%>" width="116" height="87" style="border: 1px solid #FFFFFF; "></a></td>
									<td>
									<div align="center">
										...
										<font size="2" face="Tahoma">&nbsp;İ.No</font></td>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satiliklarmrh("id")%></font></td>
											</tr>
											<tr>
												<td width="40">
											...
											<tr>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satiliklarmrh("ilan_tip")%></font></td>
											</tr>
											<tr>
												<td width="40">
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satiliklarmrh("tip")%></font></td>
											</tr>
										</table>
									</div>
									</td>
      ...
      </td><%If metallica=3 OR metallica=6 OR metallica=9 OR metallica=12 OR metallica=15 OR metallica=18 OR metallica=21 OR metallica=24 OR metallica=27 OR metallica=30 OR metallica=33 OR metallica=36 OR metallica=39 OR metallica=42 OR metallica=45 OR metallica=48 OR metallica=51 OR metallica=54 OR metallica=57 OR metallica=60 OR metallica=63 OR metallica=66 OR metallica=69 OR metallica=72 OR metallica=75 OR metallica=78 OR metallica=81 OR metallica=84 OR metallica=87 OR metallica=90 OR metallica=93 OR metallica=96 OR metallica=99 OR metallica=102 Then Response.Write"</tr><tr><td colspan=""2"" height=""10""></td></tr><tr>"End If:metallica=metallica+1:satiliklarmrh.MoveNext:Loop%>
   </tr>
   <tr>
