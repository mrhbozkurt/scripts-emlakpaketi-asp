...
<title>Satılık Binalar | <%=emrahbozkurt("sitebasligi")%></title>
...
<table cellpadding="0" cellspacing="0" width="801" height="95%">
   <tr><%metallicamrhbozkurt=1:Set satlikbinamrh=Conn.Execute("SELECT * FROM ilanlar where satlikbina=1 ORDER BY id Asc"):Do while Not satlikbinamrh.Eof:Set cit=Conn.Execute("SELECT * FROM iller WHERE id=" & satlikbinamrh("il")):Set city=Conn.Execute("SELECT * FROM ilceler WHERE id=" & satlikbinamrh("ilce")):Set dtm=Conn.Execute("SELECT * FROM ilceler WHERE id=" & satlikbinamrh("ilce")):Set dtf=Conn.Execute("SELECT * FROM iller WHERE id=" & satlikbinamrh("il"))%>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table11" height="93">
								<tr>
									<td width="121">
									<p align="center">
									<a href="ilan.asp?s-emlak=ilandetayi&id=<%=satlikbinamrh("id")%>">
									<img alt="<%=satlikbinamrh("ilanbaslik")%>" border="0" src="yonetim/<%If Not satlikbinamrh("resim1")="" Then%><%=satlikbinamrh("resim1")%><%Else%>ilanfoto/smultimedya_foto_yok.jpg<%End If%>" width="116" height="87" style="border: 1px solid #FFFFFF; "></a></td>
									<td>
									<div align="center">
										...
										<font size="2" face="Tahoma">&nbsp;İ.No</font></td>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satlikbinamrh("id")%></font></td>
											</tr>
											<tr>
												<td width="40">
											...
											<tr>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satlikbinamrh("ilan_tip")%></font></td>
											</tr>
											<tr>
												<td width="40">
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=satlikbinamrh("tip")%></font></td>
											</tr>
										</table>
									</div>
									</td>
