...
<title>Arsa & Araziler | <%=emrahbozkurt("sitebasligi")%></title>
			...
			<div align="center">
				<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" bordercolor="#C0C0C0" id="table11" bgcolor="#000000" height="23">
					<tr>
						<td>
						<p align="center">
						<font face="Verdana" size="2" color="#FFFFFF">Arsa &amp; 
						Arazi</font></td>
					</tr>
				</table>
			</div>
...
<table cellpadding="0" cellspacing="0" width="801" height="95%">
   <tr><%metallicamrhbozkurt=1:Set arasa_arazimrh=Conn.Execute("SELECT * FROM ilanlar where arasa_arazi=1 ORDER BY id Asc"):Do while Not arasa_arazimrh.Eof:Set cit=Conn.Execute("SELECT * FROM iller WHERE id=" & arasa_arazimrh("il")):Set city=Conn.Execute("SELECT * FROM ilceler WHERE id=" & arasa_arazimrh("ilce")):Set dtm=Conn.Execute("SELECT * FROM ilceler WHERE id=" & arasa_arazimrh("ilce")):Set dtf=Conn.Execute("SELECT * FROM iller WHERE id=" & arasa_arazimrh("il"))%>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table11" height="93">
								<tr>
									<td width="121">
									<p align="center">
									<a href="ilan.asp?s-emlak=ilandetayi&id=<%=arasa_arazimrh("id")%>">
									<img alt="<%=arasa_arazimrh("ilanbaslik")%>" border="0" src="yonetim/<%If Not arasa_arazimrh("resim1")="" Then%><%=arasa_arazimrh("resim1")%><%Else%>ilanfoto/smultimedya_foto_yok.jpg<%End If%>" width="116" height="87" style="border: 1px solid #FFFFFF; "></a></td>
									<td>
									<div align="center">
										...
										<font size="2" face="Tahoma">&nbsp;İ.No</font></td>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=arasa_arazimrh("id")%></font></td>
											</tr>
											<tr>
												<td width="40">
											...
											<tr>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=arasa_arazimrh("ilan_tip")%></font></td>
											</tr>
											<tr>
												<td width="40">
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=arasa_arazimrh("tip")%></font></td>
											</tr>
										</table>
									</div>
									</td>
