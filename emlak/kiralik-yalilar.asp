...
<title>Kiralık Yalılar | <%=emrahbozkurt("sitebasligi")%></title>
...
<table cellpadding="0" cellspacing="0" width="801" height="95%">
   <tr><%metallicamrhbozkurt=1:Set kiralikyalimrh=Conn.Execute("SELECT * FROM ilanlar where kiralikyali=1 ORDER BY id Asc"):Do while Not kiralikyalimrh.Eof:Set cit=Conn.Execute("SELECT * FROM iller WHERE id=" & kiralikyalimrh("il")):Set city=Conn.Execute("SELECT * FROM ilceler WHERE id=" & kiralikyalimrh("ilce")):Set dtm=Conn.Execute("SELECT * FROM ilceler WHERE id=" & kiralikyalimrh("ilce")):Set dtf=Conn.Execute("SELECT * FROM iller WHERE id=" & kiralikyalimrh("il"))%>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table11" height="93">
								<tr>
									<td width="121">
									<p align="center">
									<a href="ilan.asp?s-emlak=ilandetayi&id=<%=kiralikyalimrh("id")%>">
									<img alt="<%=kiralikyalimrh("ilanbaslik")%>" border="0" src="yonetim/<%If Not kiralikyalimrh("resim1")="" Then%><%=kiralikyalimrh("resim1")%><%Else%>ilanfoto/smultimedya_foto_yok.jpg<%End If%>" width="116" height="87" style="border: 1px solid #FFFFFF; "></a></td>
									<td>
									<div align="center">
										...
										<font size="2" face="Tahoma">&nbsp;İ.No</font></td>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikyalimrh("id")%></font></td>
											</tr>
											<tr>
												<td width="40">
											...
											<tr>
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikyalimrh("ilan_tip")%></font></td>
											</tr>
											<tr>
												<td width="40">
												...
												:</td>
												<td>
												<font size="2" face="Tahoma" color="#FFFFFF">&nbsp;<%=kiralikyalimrh("tip")%></font></td>
											</tr>
										</table>
									</div>
									</td>
